...
(function() {
  Formbuilder.registerField('location', {
    order: 55,
    view: "<div><input type='checkbox' checked /></div>",
    edit: "",
...
(function() {
  Formbuilder.registerField('picture', {
    order: 60,
    view: "<div><input type='checkbox' checked /></div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-file-image-o\"></span></span> Picture",
...
(function() {
  Formbuilder.registerField('signature', {
    ...
    view: "<div><input type='checkbox' checked /></div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-check  \"></span></span> Signature"
  });
...
(function() {
  Formbuilder.registerField('video', {
    ...
    view: "<div><input type='checkbox' checked /></div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-video-camera  \"></span></span> Video"
  });
